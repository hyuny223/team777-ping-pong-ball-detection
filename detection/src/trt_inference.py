...
CFG = "/home/nvidia/xycar_ws/src/detection/info/yolov3-tiny_tstl_416.cfg"
TRT = '/home/nvidia/xycar_ws/src/detection/model/model_epoch3200.trt'

NUM_CLASS = 2
INPUT_IMG = '/home/nvidia/xycar_ws/src/detection/detection/'
...
class yolov3_trt(object):
    ...
    def detect(self):
        ...
        img_list = glob.glob("/home/nvidia/xycar_ws/src/detection/pingpong_project/detection/score/data/*.jpg")
        line_temp = [[],[],[],[],[],[],[]]

        for img in img_list:
            xycar_image = cv2.imread(img)
            image_file_name = img.replace("/home/nvidia/xycar_ws/src/detection/pingpong_project/distance/image/","")
            ...
            if self.show_img:
                ...
                cv2.waitKey(1)
        line.to_csv('/home/nvidia/xycar_ws/src/detection/pingpong.csv',header=False, index=False)
