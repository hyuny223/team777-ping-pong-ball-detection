...
def parse_args():
    parser = argparse.ArgumentParser(description="image flattening")
...
if __name__ == "__main__":
    ...
    # print(cal.get_camera_matrix())
    cal.UNDISTORTED_IMG_DIR = args.save_path
    cal.undistort(sorted(glob.glob(args.img_path + "*" + ".png")), camera_matrix, dist_coeffs)
